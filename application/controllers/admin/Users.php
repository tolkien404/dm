...
class Users extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('admin/M_users', 'musers');
	...
	public function index()
	{
		$data = array(
			...
			'data' => $this->musers->getUser(),
			'anggota' => $this->manggota->getAnggota()

		);
		$this->load->view($this->_module . '/users/v_users', $data);
	}

	public function ubah()
	{
		$id = $this->input->post('i-id_anggota');
		$data = array(
