...
<title>Dashboard - Admin Control</title>
 ...
 <div class="page-header">
        <h1 class="page-title">Bootstrap Tables</h1>
        <ol class="breadcrumb">
        ...
        <div class="page-header-actions">
          <a class="btn btn-sm btn-primary btn-round waves-effect waves-classic" href="https://github.com/wenzhixin/bootstrap-table" target="_blank">
