...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets/global/css/bootstrap-extend.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/css/siteuser.min.css') ?>" rel="stylesheet" type="text/css">

    <!-- Plugins -->
    <link href="<?php echo base_url('assets/global/vendor/animsition/animsition.min.css') ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url('assets/global/vendor/chartist/chartist.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/global/vendor/jvectormap/jquery-jvectormap.css') ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css') ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url('assets/global/vendor/sweetalert/dist/sweetalert.css') ?>" rel="stylesheet" type="text/css">
