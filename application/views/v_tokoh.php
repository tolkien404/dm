<title>Tokoh Inspiratif - Iluni Dm Unbor</title>
<?php
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Tokoh Inspiratif</li>
				</ol>
			</div>
		</div>
	</div>
				...
				<div class="col-md-12 posts-archive">
					<article class="post">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8">
								...
								<span class="post-meta meta-data"> <span><i class="fa fa-calendar"></i> 28th Jan, 2014</span><span><i class="fa fa-archive"></i> <a href="#">Uncategorized</a></span></span>
					...
					<article class="post">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8">
								<h3><a href="single-event.html">A sample post title</a></h3>
								<span class="post-meta meta-data"> <span><i class="fa fa-calendar"></i> 28th Jan, 2014</span><span><i class="fa fa-archive"></i> <a href="#">Alumi</a></span></span>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam.</p>
								<p><a href="#" class="btn btn-primary">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
							</div>
						</div>
